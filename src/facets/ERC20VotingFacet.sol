...
import "../Proxies/VoteProxyFactoryDiamond.sol";
...
library ERC20VotingLib {

    bytes32 constant DIAMOND_STORAGE_POSITION = keccak256("Fyde.Governance.ERC20Voting.v1");

    struct ERC20VotingStorage {
        address governanceToken;
        address treasuryToken;
        address governor;
        address tokenPool;
        address proxyFactory;
        bool isGovernorAlpha;
    }

    function diamondStorage() internal pure returns (ERC20VotingStorage storage ds) {
...
contract ERC20VotingFacet {
    ...
    */
    ...
    constructor(
        ...
        ERC20VotingLib.ERC20VotingStorage storage facetState = ERC20VotingLib.diamondStorage();

        facetState.governanceToken = _governanceToken;
        facetState.governor = _governor;
        facetState.tokenPool = _tokenPool;
        facetState.proxyFactory = msg.sender;
        facetState.treasuryToken = _treasuryToken;
        facetState.isGovernorAlpha = _isGovernorAlpha;
    }
    ...
    */
    function proxyVote(uint8 _vote, uint256 _proposalID) external {
        bool isGovernorAlpha = ERC20VotingLib.diamondStorage().isGovernorAlpha;
        address governor = ERC20VotingLib.diamondStorage().governor;
    ...
    */
    function deFundMe() public {
        address governanceToken = ERC20VotingLib.diamondStorage().governanceToken;
        address treasuryToken = ERC20VotingLib.diamondStorage().treasuryToken;
        address tokenPool = ERC20VotingLib.diamondStorage().tokenPool;
    ...
    */
    function fundMe(uint256 _stakeAmount, uint _proposalID ,uint256 _tsryPrice) external {
