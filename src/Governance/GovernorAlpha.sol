...
contract GovernorAlpha {
    ...
    function quorumVotes() public pure returns (uint) { return 400000e18; } // 400,000 = 4% of uni

    /// @notice The number of votes required in order for a voter to become a proposer
    function proposalThreshold() public pure returns (uint) { return 100000e18; } // 100,000 = 1% of uni
    ...
    /// @notice The address of the Uni governance token
    ...
    constructor(address timelock_, address uni_, address guardian_) {
    ...
    function cancel(uint proposalId) public {
        ...
        Proposal storage proposal = proposals[proposalId];
        require(msg.sender == guardian || uni.getPriorVotes(proposal.proposer, sub256(block.number, 1)) < proposalThreshold(), "GovernorAlpha::cancel: proposer above threshold");
